...
class Reaction(commands.Cog, name="message_reactions"):
    ...
    async def on_message(self, message):
        ...
        await self.generic_react(message, r"(?:.*?\W|^)(?:kobold|lizard|lizzer|will|balaur)(?:\W|$)", username_react_delay, 1, random.choice(["<carbold:1462921633177141318>", "<tinybold:1462923072007835753>", "<lizzer:1462923230011588639>", "<polite:1462923370717905026>"]), 1462923370717905026, max_reactions_before_cooldown=10)
